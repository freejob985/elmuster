...
//ZainCash
Route::get('/zaincash/check','ZainCashController@CheckPayment')->name('zaincash.check');
Route::get('/medo/testegyweb',function (){
    try {
...
Route::get('egy/error',function (\Illuminate\Http\Request $request){
