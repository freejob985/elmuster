        ...
        <div class="container">
            <div class="d-flex justify-content-between align-items-center">
                <div class="logo">
                    ...
                    <a class="menu-a"
                        href="{{url('/')}}/search?keyword=&type=freelancer">{{ translate('Freelancers') }}</a>
                    <a class="menu-a"
                        href="{{url('/')}}/search?keyword=&type=project">{{ translate('Projects') }}</a>
                    <a class="menu-a"
                        href="{{url('/')}}/search?keyword=&type=service">{{ translate('Services') }}</a>
                </div>
                    ...
                    <div class="front-header-search d-flex align-items-center bg-white px-3 px-lg-0">
                        <form action="{{ route('search') }}" method="GET" class="flex-grow-1">
                            <div class="input-group">
                                ...
                                <div class="input-group-prepend flex-grow-1  d-sm-block">
